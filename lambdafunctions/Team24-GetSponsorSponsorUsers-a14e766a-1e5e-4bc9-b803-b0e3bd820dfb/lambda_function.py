...
def lambda_handler(event, context):
    ...
    try:
        ...
        sponsor_id = query_params.get('sponsorOrgId')
        ...
        cursor.callproc("GetSponsorUsers", (sponsor_id,))

        # Retrieve results from the stored procedure call
        sponsor_users = []
        for result in cursor.stored_results():
            sponsor_users.extend(result.fetchall())  # Properly collect all results
        ...
        return {
            ...
            'body': json.dumps(sponsor_users, default=str)
