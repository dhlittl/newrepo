    ...
    try:
        ...
        if method == 'PUT':
            ...
            if record:
                ...
                cursor.callproc('UpdateAdminWidgetOrder', (user_id, json.dumps(widget_order)))
            else:
                print(f"No record found for User_ID: {user_id}, inserting widget order...")
                cursor.execute("INSERT INTO Admin_Preferences (user_id, widget_order) VALUES (%s, %s)", (user_id, json.dumps(widget_order)))
            ...
            cursor.callproc('GetAdminWidgetOrder', (User_ID,))
            widget_order = None
